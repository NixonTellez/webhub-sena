...
<body>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="btn-group flex-wrap btn-group-toggle">
                                    ...
                                    <a onclick="window.open(this.href,'_blank');return false;" href="../procesos/consultaAmbiente.php" class="btn btn-secondary"><i class="fa-solid fa-circle-chevron-down"></i> Exportar a excel</a>
                                    <a href="../html/solicitudes.php" class="btn btn-secondary"><i class="fa-solid fa-list-check"></i> Solicitudes</a>
                                </div>
                            </div>
                        </div>
                        <hr>
    ...
    <?php require_once "modalInsertAmbiente.php" ?>
    <?php require_once "modalUpdateAmbiente.php" ?>
